...
# ## test PHI
python test_simulation.py phi_prior_true_chr22 False chr22 0.2 True True --refit_time 5 
python test_simulation.py phi_prior_false_chr22 False chr22 0.2 False True --refit_time 5 

## test perfect anno
#python test_simulation.py prop_nz_0.1_chr22 False chr22 0.1 True True --refit_time 10 
#python test_simulation.py prop_nz_0.05_chr22 False chr22 0.05 True True --refit_time 10 

# # # test sigma
# python test_simulation.py sigma_false_chr22 False chr22 0.2 True False --refit_time 5 
# python test_simulation.py sigma_true_chr22 False chr22 0.2 True True --refit_time 5